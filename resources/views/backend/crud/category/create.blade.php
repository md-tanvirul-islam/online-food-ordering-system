        ...
        <div class="container">
            <div class="card" style="color: black; margin-top:10px;  width: 100%;">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-9">
                                    ...
                                    <p class="card-text"><small> Please enter valid Category info</small></p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm">
                                    {!! Form::open(['route'=>'categories.store','files'=>true,'class'=>[]]) !!}

                                        
                                    @include('backend.crud.category.form')
        

                                                <label for="image"><b>Upload category Image:</b></label> 
                                                <br>
                                                {!! Form::file('image') !!}
